// public/post.js - Wersja ostateczna

let currentUser = null;
let postId = null;

function showBanner(msg, ok = true) {
  // ... (twoja funkcja showBanner bez zmian lub skopiuj z poprzedniej odpowiedzi) ...
...
async function loadComments() {
  try {
    ...
    list.innerHTML = comments.map(c => {
        ...
        // Używamy window.rateComment w onclick
        return `
...
// PRZYPISANIE DO WINDOW (GLOBALNE) - TO JEST KLUCZOWE DLA ONCLICK
window.rateComment = async (id, rating) => {
    console.log('Kliknięto rate:', id, rating); // SPRAWDŹ KONSOLĘ CZY TO SIĘ POJAWIA
